...
./liquibase --driver=com.informix.jdbc.IfxDriver --url="jdbc:informix-sqli://${HOSTNAME}:${INFORMIX_PORT}/${DBNAME}:INFORMIXSERVER=${INFORMIXSERVER};DB_LOCALE=en_US.utf8" --defaultSchemaName="informix" --classpath="/opt/zfin/source_roots/$INSTANCE/ZFIN_WWW/lib/Java/ifxjdbc-4.10.JC8DE.jar" --changeLogFile="/tmp/changelogMigrationFile.xml" generateChangeLog
