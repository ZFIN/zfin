...
my %avoids = (
    ...
    "sequence_feature_chromosome_location_generated_staging:sfclg_location_source" => 1,
    "sequence_feature_chromosome_location_generated_staging:sfclg_location_subsource" => 1,
    "term:term_comment" => 1,
