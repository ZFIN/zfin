...
my %avoids = (
    ...
    "elsevier_statistics:es_incoming_ip" => "avoid",   # not displayed anywhere
    "elsevier_statistics:es_zfin_url" => "avoid",   # not displayed anywhere
    "elsevier_statistics:es_figure_zdb_id" => "avoid",   # not displayed anywhere
    "elsevier_statistics:es_external_link" => "avoid",   # not displayed anywhere
    "elsevier_statistics:es_http_user_agent" => "avoid",   # not displayed anywhere
