create temporary table tmp_union (chromosome varchar(10),
			zdb_id text,
			subsource text
);
insert into tmp_union (chromosome, zdb_id, subsource)			
...
create temp table tmp_full (chromosome varchar(10),
				zdb_id text,
				source text,
				subsource text)
;
insert into tmp_full (chromosome, zdb_id, source, subsource)
