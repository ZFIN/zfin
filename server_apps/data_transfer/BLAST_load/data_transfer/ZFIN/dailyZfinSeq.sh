...
@TARGET_PATH@/ZFIN/zfin_mrph/processzfin_mrph.sh

echo "";
echo "";

echo "process zfin_publishedProtein" ;
@TARGET_PATH@/ZFIN/zfin_publishedProtein/processzfin_publishedProtein.sh

echo "";
echo "";

echo "process zfin_unreleasedProtein" ;
@TARGET_PATH@/ZFIN/zfin_unreleasedProtein/processzfin_unreleasedProtein.sh

echo "";
echo "";

echo "process zfin_vega" ;
@TARGET_PATH@/ZFIN/zfin_vega/processzfin_vega.sh

echo "";
echo "";

echo "process vega_withdrawn" ;
@TARGET_PATH@/ZFIN/zfin_vegaWithdrawn/processzfin_vegaWithdrawn.sh
...
@TARGET_PATH@/ZFIN/zfin_unreleasedRNA/processzfin_unreleasedRNA.sh

echo "";
echo "";

echo "process zfin_microRNA" ;
@TARGET_PATH@/ZFIN/zfin_microRNA/processzfin_microRNA.sh

echo "";
echo "";

echo "process zfin_genomicDNA" ;
@TARGET_PATH@/ZFIN/zfin_genomicDNA/processzfin_genomicDNA.sh

echo "";
echo "";

echo "process zfin_publishedRNA" ;
@TARGET_PATH@/ZFIN/zfin_publishedRNA/processzfin_publishedRNA.sh

echo "";
echo "";

echo "process zfin_crispr" ;
@TARGET_PATH@/ZFIN/zfin_crispr/processzfin_crispr.sh

echo "";
echo "";

echo "process zfin_talen" ;
@TARGET_PATH@/ZFIN/zfin_talen/processzfin_talen.sh
