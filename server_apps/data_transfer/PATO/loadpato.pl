...
&isEmptyFile ("term_no_longer_secondary.txt","No secondary terms are now primary","<!--|VALIDATION_EMAIL_DBA|-->","Error in quality.obo?  Terms once secondary are now primary.");
