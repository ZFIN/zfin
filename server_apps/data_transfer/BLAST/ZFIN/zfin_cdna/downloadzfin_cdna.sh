...
/local/bin/wget "http://zfin.org/action/blast/blast-files?action=GENBANK_CDNA" -O $WEBHOST_FASTA_FILE_PATH/zfin_cdna/zfin_genbank_cdna_acc.unl
...
/local/bin/wget "http://@WEBHOST_HOSTNAME@/action/blast/blast-files?action=GENBANK_ALL" -O $WEBHOST_FASTA_FILE_PATH@/zfin_genbank_acc.unl
