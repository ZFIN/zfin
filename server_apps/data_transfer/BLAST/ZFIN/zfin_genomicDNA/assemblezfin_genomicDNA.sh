...
xdget -n -f -e xdget_zfin_genomic_genbank_acc.log -o $BLASTSERVER_FASTA_FILE_PATH/zfin_genomic_dna_all_mrna.fa -Tgb1 $BLAST_PATH/Current/gbk_zf_mrna $WEBHOST_FASTA_FILE_PATH/zfin_genomic_genbank_acc.unl

xdget -n -f -e xdget_zfin_genomic_genbank_acc.log -o $BLASTSERVER_FASTA_FILE_PATH/zfin_genomic_dna_all_rna.fa -Tgb1 $BLAST_PATH/Current/gbk_zf_rna $WEBHOST_FASTA_FILE_PATH/zfin_genomic_genbank_acc.unl

xdget -n -f -e xdget_zfin_genomic_genbank_acc.log -o $BLASTSERVER_FASTA_FILE_PATH/zfin_genomic_dna_all_dna.fa -Tgb1 $BLAST_PATH/Current/gbk_zf_dna $WEBHOST_FASTA_FILE_PATH/zfin_genomic_genbank_acc.unl
