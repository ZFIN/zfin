...
FILENAME=GPL1319
$CP -f ${FILENAME}_family.soft old.${FILENAME}_family.soft ; 
$WGET -q -O ${FILENAME}_family.soft.gz ftp://ftp.ncbi.nih.gov/pub/geo/DATA/SOFT/by_platform/${FILENAME}/${FILENAME}_family.soft.gz   ; 
...
FILENAME=GPL2715
$CP -f $MICROARRAY_PATH/${FILENAME}_family.soft $MICROARRAY_PATH/old.${FILENAME}_family.soft ; 
$WGET -q -O ${FILENAME}_family.soft.gz ftp://ftp.ncbi.nih.gov/pub/geo/DATA/SOFT/by_platform/${FILENAME}/${FILENAME}_family.soft.gz ;
