...
def getDB() {
    ...
    db = Sql.newInstance("jdbc:informix-sqli://${props['SQLHOSTS_HOST']}:${props['INFORMIX_PORT']}/${props['DBNAME']}:INFORMIXSERVER=${props['INFORMIXSERVER']}",'zfinner','Rtwm4ts','com.informix.jdbc.IfxDriver'
    )
