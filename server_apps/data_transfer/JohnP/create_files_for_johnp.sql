UNLOAD to '<!--|FTP_ROOT|-->/pub/transfer/JohnP/accession.txt'
  DELIMITER "	" select distinct mrkr_zdb_id, mrkr_abbrev, acc_num  from marker, OUTER db_link  where ((mrkr_type = 'EST') or (mrkr_type like 'GENE%'))  and linked_recid = mrkr_zdb_id and db_name = 'Genbank' order by 1;
