...
select count(*) from marker m inner join marker_sequence s on s.seq_mrkr_zdb_id = m.mrkr_zdb_id where m.mrkr_type in ('MRPHLNO', 'CRISPR') And m.mrkr_zdb_id not in ('ZDB-CRISPR-230804-4','ZDB-CRISPR-250226-1')