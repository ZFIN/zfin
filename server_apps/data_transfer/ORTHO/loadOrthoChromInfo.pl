...
system("/local/bin/wget -q ftp://flybase.net/genomes/Drosophila_melanogaster/current/fasta/dmel-all-gene-r5.6.fasta.gz -O FlyBase.data.gz") and &emailError("Cannot download data file from FlyBase.");
