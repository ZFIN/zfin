...
public enum Ontology implements Serializable {
    ...
    AOGODOCHEBI(ANATOMY.getOntologyName() + "," + GO.getOntologyName() + "," + DISEASE_ONTOLOGY.getOntologyName()+ "," + CHEBI.getOntologyName(), "AO, GO, DO and ChEBI", true),
    ...
    OBI("obi", "Ontology for Biomedical Investigations", false, "OBI:", false, false);
    ...
    public boolean containsTerm(String id) {
        return id.startsWith(oboIdPrefix);
    }
}
