...
public class ConstructEditController {
    ...
    public
    @ResponseBody
    void addConstructSequence(HttpServletRequest request, HttpServletResponse response) {
        String constructID = request.getParameter("constructEdit");
    ...
    public
    @ResponseBody
    void deleteAlias(@PathVariable String constructID, @PathVariable String aliasID) {
        HibernateUtil.createTransaction();
        Marker m = mr.getMarkerByID(constructID);
    ...
    public
    @ResponseBody
    void deleteSequence(@PathVariable String constructID, @PathVariable String sequenceID) {
        HibernateUtil.createTransaction();
    ...
    public
    @ResponseBody
    void deleteNote(@PathVariable String constructID, @PathVariable String noteID) {
