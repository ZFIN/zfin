...
public class AntibodyLabelingDetailController extends AbstractCommandController {
    ...
    public AntibodyLabelingDetailController() {
        setCommandClass(AntibodyBean.class);
    }

    protected ModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors) throws Exception {
        LOG.info("Start Antibody Labeling Detail Controller");
        ...
        modelAndView = new ModelAndView("antibody-labeling-detail.page", LookupStrings.FORM_BEAN, form);
