...
//    public RemoveButton(String text, LookupTable parentTable,int rowCount){
        public RemoveButton(Image image, LookupTable parentTable,String term){
        super(image) ;
    ...
    public class RowClickListener implements ClickListener{
        ...
        private LookupTable parentTable ;
        private String term ;

        public RowClickListener(LookupTable parentTable,String term){
