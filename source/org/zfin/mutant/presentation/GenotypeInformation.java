...
public class GenotypeInformation implements Comparable {
    ...
    public GenotypeInformation(Genotype genotype) {
    ...
    public int compareTo(Object o) {
        GenotypeInformation otherFtrGenoStat = (GenotypeInformation)o;
