...
public class MarkerDTO extends RelatedEntityDTO {
    ...
    public void setPublicNotes(List publicNotes) {
    ...
    public MarkerDTO deepCopy() {
        ...
        markerDTO.setSupportingSequenceLinks(supportingSequenceLinks);
        markerDTO.setZdbID(zdbID);
        markerDTO.setName(name);
        markerDTO.setAbbreviationOrder(abbreviationOrder);
        markerDTO.setMarkerType(markerType);
        markerDTO.setLink(link);
        markerDTO.setPublicationZdbID(publicationZdbID);
        markerDTO.setMarkerRelationshipType(markerRelationshipType);
        markerDTO.setZdbIDThenAbbrev(zdbIDThenAbbrev);
        return markerDTO ;
    }
