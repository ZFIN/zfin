...
/**
 */
public final class CloneInfoBox extends Composite {
    ...
    protected void initGUI() {
        ...
        libraryListBox.addChangeListener(new ChangeListener() {
            public void onChange(Widget w) {
                checkDirty();
            }
        });
        cloneRatingListBox.addChangeListener(new ChangeListener() {
            public void onChange(Widget w) {
                checkDirty();
            }
        });
        vectorListBox.addChangeListener(new ChangeListener() {
            public void onChange(Widget w) {
                checkDirty();
            }
        });
        digestListBox.addChangeListener(new ChangeListener() {
            public void onChange(Widget w) {
                checkDirty();
            }
        });
        polymeraseListBox.addChangeListener(new ChangeListener() {
            public void onChange(Widget w) {
                checkDirty();
            }
        });
        problemTypeListBox.addChangeListener(new ChangeListener() {
            public void onChange(Widget w) {
                checkDirty();
            }
        });
        cloningSiteListBox.addChangeListener(new ChangeListener() {
            public void onChange(Widget w) {
                checkDirty();
            }
        });
