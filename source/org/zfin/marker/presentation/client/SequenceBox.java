...
import org.zfin.marker.presentation.event.SequenceChangeEvent;
import org.zfin.marker.presentation.event.SequenceChangeListener;
...
public class SequenceBox extends Composite implements SequenceChangeListener {
    ...
    protected void initGui(){
        ...
        sequenceArea.addChangeListener(new ChangeListener(){
            public void onChange(Widget widget) {
                fireSequenceBoxChangeEvent(new SequenceChangeEvent());
            }
        });
        sequenceArea.addClickListener(new ClickListener(){
