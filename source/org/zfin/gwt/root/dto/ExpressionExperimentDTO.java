...
public class ExpressionExperimentDTO implements IsSerializable, Comparable<ExpressionExperimentDTO> {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof ExpressionExperimentDTO))
            return false;

        ExpressionExperimentDTO experiment = (ExpressionExperimentDTO) o;
    ...
    public int compareTo(ExpressionExperimentDTO compExperiment) {
