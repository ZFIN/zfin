...
/**
 */
public class ConstructRelationshipDTO extends RelatedEntityDTO{

    private String zdbID ;

    public ConstructDTO getConstructDTO() {
        return constructDTO;
    }

    public void setConstructDTO(ConstructDTO constructDTO) {
        this.constructDTO = constructDTO;
    }

    private ConstructDTO constructDTO ;
    ...
    public boolean equals(Object obj) {
        ...
        if(obj instanceof ConstructRelationshipDTO){
            ConstructRelationshipDTO otherDTO = (ConstructRelationshipDTO) obj ;
