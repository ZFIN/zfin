...
public final class ZircPhenotypeFormSchema {
     ...
     * checkboxGroup pick list (closed — no "Other"). The
    ...
    /**
     * Canonical phenotype types (ZFIN-10349). Rendered as a checkboxGroup
     * pick list with an "Other" free-text entry for values outside the list.
     */
