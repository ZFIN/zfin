...
public enum ForeignKey {
    ...
    XPATEX_GENOX(Table.FISH_EXPERIMENT, Table.EXPRESSION_EXPERIMENT2, "xpatex_genox_zdb_id"),
    ...
    XPATRES_START_STAGE(Table.STAGE, Table.EXPRESSION_RESULT2, "xpatres_start_stg_zdb_id"),
    XPATRES_END_STAGE(Table.STAGE, Table.EXPRESSION_RESULT2, "xpatres_end_stg_zdb_id"),
    XPAT_TERM_1(Table.TERM, Table.EXPRESSION_RESULT2, "xpatres_superterm_zdb_id"),
    XPAT_TERM_2(Table.TERM, Table.EXPRESSION_RESULT2, "xpatres_subterm_zdb_id"),
    ...
    XPATEX_STAGE(Table.EXPRESSION_EXPERIMENT2, Table.EXPRESSION_FIGURE_STAGE, "efs_xpatex_zdb_id"),
    STAGE_XPATRES(Table.EXPRESSION_FIGURE_STAGE, Table.EXPRESSION_RESULT2, "xpatres_efs_id"),
    FIGURE_XPATRES_ASSOC(Table.FIGURE, Table.EXPRESSION_RESULT2, Table.FIGURE_XPATRES),
    ...
    XPATRES_FIGURE_ASSOC(Table.EXPRESSION_RESULT2, Table.FIGURE, Table.XPATRES_FIGURE),
    ...
    XPATEX_GENE(Table.MARKER, Table.EXPRESSION_EXPERIMENT2, "xpatex_gene_zdb_id"),
    XPATEX_ANTIBODY(Table.MARKER, Table.EXPRESSION_EXPERIMENT2, "xpatex_atb_zdb_id"),
    XPATEX_PROBE(Table.MARKER, Table.EXPRESSION_EXPERIMENT2, "xpatex_probe_feature_zdb_id"),
    ...
    XPATEX_PUB(Table.PUBLICATION, Table.EXPRESSION_EXPERIMENT2, "xpatex_source_zdb_id"),
    ...
    NOTE_EXT_GENOX(Table.FISH_EXPERIMENT, Table.EXTERNAL_NOTE, "extnote_data_zdb_id"),
    ...
    RECORD_ATTR_XPAT(Table.EXPRESSION_EXPERIMENT2, Table.RECORD_ATTRIBUTION, "recattrib_data_zdb_id"),
    ...
    XPATEX_DBLINK(Table.DBLINK, Table.EXPRESSION_EXPERIMENT2, "xpatex_dblink_zdb_id"),
    ...
    XPATRES_FEATSTAT(Table.EXPRESSION_RESULT2, Table.FEATURE_STAT, "fstat_xpatres_zdb_id"),
    ...
    EXTERNAL_REFERENCE_TERM(Table.TERM, Table.EXTERNAL_REFERENCE, "exref_data_zdb_id"),
