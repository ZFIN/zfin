...
public enum Table {
    ...
    CONSTRUCT_GROUP_MEMBER("CONST_GROUP_MEMBER", "construct_group_member", "cgm_pk_id"),
    ...
    MORPHOLINO("MRPHLNO", "marker_sequence", "seq_mrkr_zdb_id"),
    ...
    GENOTYPE_FEATURE("GENOTYPE_FEATURE", "genotype_feature", "genofeat_geno_zdb_id,genofeat_feature_zdb_id", GENOTYPE, FEATURE),
