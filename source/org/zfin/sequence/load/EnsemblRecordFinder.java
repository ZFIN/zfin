...
public class EnsemblRecordFinder {
    ...
    public void init() throws IOException {
        ...
        System.out.println("ENSDARG IDs in ZFIN that are obsoleted at Ensembl: " + invalidEnsdargIDs);
        System.exit(0);
...
*/
    ...
    private static Map<String, List<RichSequence>> getGeneTranscriptMap(String fileName) {
        try {
            ...
            return transcriptList.stream().collect(Collectors.groupingBy(EnsemblRecordFinder::getGeneId));
