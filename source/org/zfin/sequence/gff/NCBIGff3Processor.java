...
public class NCBIGff3Processor {
    ...
    private void start() throws IOException {
        ...
        // Reconciling stale locations belongs to the NCBI gene load, not here. That is the job
        // that invalidates a (gene, accession) pairing, and it runs weekly where this one is
        // manual - see NCBIDirectPort.reconcileNcbiGenomeLocations(), which also re-points a
        // location whose accession moved to another gene rather than only deleting it.
