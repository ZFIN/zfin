 ...
 *
 */
public class ExternalBlastController extends AbstractController {
...
//            for vega
            if(database.getAbbrev() == Database.AvailableAbbrev.VEGA_BLAST){
                ...
                if(referenceDatabase.isShortSequence()){
...
//            <%--for ncbi MegaBlast --%>
            ...
            if(database.getAbbrev() == Database.AvailableAbbrev.MEGA_BLAST){
                hiddenVariables.put("QUERY",sequence.getData()) ;
            ...
            if(database.getAbbrev() == Database.AvailableAbbrev.ENSEMBL){
                hiddenVariables.put("_query_sequence",sequence.getData()) ;
                hiddenVariables.put("species","Danio_rerio") ;
                if(referenceDatabase.isShortSequence()){
                    hiddenVariables.put("method","BLASTN") ;
            ...
            if(database.getAbbrev() == Database.AvailableAbbrev.UCSC_BLAT){
            ...
            if(database.getAbbrev() == Database.AvailableAbbrev.ZFIN_CDNA_SEQ){
                hiddenVariables.put("program","blastn") ;
            ...
            if (database.getAbbrev() == Database.AvailableAbbrev.ZFIN_MICRORNA
        ...
        if(database.getType() == Database.Type.PROTEIN){
            // internal blast
            ...
            if(database.getAbbrev() == Database.AvailableAbbrev.BLASTP){
                hiddenVariables.put("QUERY",sequence.getData()) ;
            }
            // ensemble?
            else
            if(database.getAbbrev() == Database.AvailableAbbrev.PBLAST){
                hiddenVariables.put("sequence",sequence.getData()) ;
            }

        }

        blastBean.setHiddenProperties(hiddenVariables);
