...
public class BlastLinkPresentation extends EntityPresentation {
    ...
    public static String getLink(HitViewBean hitViewBean) {
        if (hitViewBean.getHitDBLink() != null) {
            ...
            return sb.toString();
        } else if (hitViewBean.getZfinAccession() != null) {
            ...
            sb.append("</a>");
            return sb.toString();
        } else if (hitViewBean.getHitMarker() != null
                &&
        ...
        else if (hitViewBean.getId().startsWith("sp")) {
            return createLink(hitViewBean.getAccessionNumber(),
                    "http://www.uniprot.org/uniprot/",
                    "Uniprot");
        }
        // handle trace
        else if (hitViewBean.getId().startsWith("gnl|ti")) {
            return createLink(hitViewBean.getAccessionNumber(),
        ...
        else if (hitViewBean.getId().startsWith("gb")
                ||
