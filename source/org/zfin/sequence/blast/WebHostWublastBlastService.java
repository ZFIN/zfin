...
public abstract class WebHostWublastBlastService extends AbstractWublastBlastService {
    ...
    private static final Logger logger = LogManager.getLogger(WebHostWublastBlastService.class);
    ...
    public Sequence addSequence(Sequence sequence) throws BlastDatabaseException {
        ...
        try {
            ...
            getLock(database);
            File fastFilePath = File.createTempFile("fasta", ".fa", new File(ZfinPropertiesEnum.WEBHOST_BLAST_DATABASE_PATH.toString()));
