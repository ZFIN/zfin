 ...
 */
public class FacetCategoryComparator<T extends FacetField.Count> implements Comparator<T> {
    ...
    public int compare(T o1, T o2) {
        ...
        Category category1 = Category.getCategory(o1.getName());
        Category category2 = Category.getCategory(o2.getName());
        if (sortMap.containsKey(category1))
            s1 = sortMap.get(category1) + o1.getName();
        else
            s1 = o1.getName();

        if (sortMap.containsKey(category2))
            s2 = sortMap.get(category2) + o2.getName();
        else
            s2 = o2.getName();
