 ...
 */
public class ViewDetailController extends AbstractCommandController {

    private static Logger LOG = Logger.getLogger(ViewDetailController.class);
    ...
    protected ModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object command,
        ...
        ViewDetailController.LOG.info("Start Action Class");
