...
import org.zfin.framework.presentation.client.LookupComposite;
import org.zfin.framework.presentation.client.Ontology;
import org.zfin.framework.presentation.client.PostComposedPart;
import org.zfin.framework.presentation.gwtutils.NullpointerException;
...
public class TermEntry extends HorizontalPanel {
    ...
    private static final Map<Ontology, String> ontologyMap = new HashMap<Ontology, String>();
