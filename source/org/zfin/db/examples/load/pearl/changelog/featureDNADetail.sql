...
--changeset staylor:featureDNADetails
...
create table feature_dna_mutation_detail (fdmd_zdb_id varchar(50) not null constraint fdmd_zdb_id_not_null,
	     ...
	     fdmd_dna_sequence_of_reference_accession_number varchar(30),
	     ...
	     fdmd_exon_number int8,
	     fdmd_intron_number int8,
	     fdmd_gene_localization_term_zdb_id varchar(50)) 
