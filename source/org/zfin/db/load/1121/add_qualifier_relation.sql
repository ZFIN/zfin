...
update marker_go_term_evidence set mrkrgoev_relation_qualifier ='ZDB-TERM-180228-3' where mrkrgoev_gflag_name ='contributes to' and mrkrgoev_contributed_by!='GO_Noctua';
update marker_go_term_evidence set mrkrgoev_relation_qualifier ='ZDB-TERM-180228-2' where mrkrgoev_gflag_name='colocalizes with' and mrkrgoev_contributed_by!='GO_Noctua';
...
update marker_go_term_evidence set mrkrgoev_tag_submit_format =(select term_name from term where mrkrgoev_gflag_name=term_zdb_id) from term where mrkrgoev_relation_qualifier=term_zdb_id and mrkrgoev_contributed_by!='GO_Noctua';
update marker_go_term_evidence set mrkrgoev_tag_submit_format ='contributes_to' where mrkrgoev_gflag_name='contributes to' and mrkrgoev_contributed_by!='GO_Noctua';
update marker_go_term_evidence set mrkrgoev_tag_submit_format ='colocalizes_with' where mrkrgoev_gflag_name='colocalizes with' and mrkrgoev_contributed_by!='GO_Noctua';
