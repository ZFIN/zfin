...
create unique index hdsd_hds_id_ak_index on htp_dataset_sample_detail (hdsd_hds_id, hdss_stage_term_zdb_id, hdss_anatomy_super_term_zdb_id,
									hdsd_anatomy_sub_term_Zdb_id, hdss_anatomy_super_term_qualifier_zdb_id,
									hdsd_anatomy_sub_term_qualifier_zdb_id, hdss_cellular_component_term_Zdb_id,
...
alter table htp_dataset_sample_detail
  add constraint hdsd_alternate_key unique (hdsd_hds_id, hdsd_stage_term_zdb_id, hdsd_anatomy_super_term_zdb_id,
