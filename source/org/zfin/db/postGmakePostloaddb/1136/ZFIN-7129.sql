...
-- ENSDARG00000001014
insert into record_attribution (recattrib_data_zdb_id, recattrib_source_zdb_id)
VALUES ('ZDB-DBLINK-150106-2658', 'ZDB-PUB-170202-7');

-- ENSDARG00000041735
insert into record_attribution (recattrib_data_zdb_id, recattrib_source_zdb_id)
VALUES ('ZDB-DBLINK-120813-28733', 'ZDB-PUB-170202-7');

-- ENSDARG00000019658
insert into record_attribution (recattrib_data_zdb_id, recattrib_source_zdb_id)
VALUES ('ZDB-DBLINK-200922-7042', 'ZDB-PUB-170202-7');
...
-- ENSDARG00000054542
/*insert into record_attribution (recattrib_data_zdb_id, recattrib_source_zdb_id)
VALUES ('ZDB-DBLINK-170223-69', 'ZDB-PUB-170202-7');
*/
-- ENSDARG00000069101
insert into record_attribution (recattrib_data_zdb_id, recattrib_source_zdb_id)
VALUES ('ZDB-DBLINK-170223-69', 'ZDB-PUB-170202-7');
...
-- ENSDARG00000073713
insert into record_attribution (recattrib_data_zdb_id, recattrib_source_zdb_id)
VALUES ('ZDB-DBLINK-161003-11057', 'ZDB-PUB-170202-7');

-- ENSDARG00000074723
insert into record_attribution (recattrib_data_zdb_id, recattrib_source_zdb_id)
VALUES ('ZDB-DBLINK-150106-269', 'ZDB-PUB-170202-7');

drop table ensdarg_tt;
drop table ensdarg_tt_no_dups;
