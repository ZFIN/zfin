...
update construct set construct_name='Tg(gja9a.5:Cas.Fanac-2A-mCherry)' where construct_zdb_id='ZDB-TGCONSTRCT-140924-3';
update marker set mrkr_name='Tg(gja9a.5:Cas.Fanac-2A-mCherry)' where mrkr_zdb_id='ZDB-TGCONSTRCT-140924-3';
update marker set mrkr_abbrev='Tg(gja9a.5:Cas.Fanac-2A-mCherry)' where mrkr_zdb_id='ZDB-TGCONSTRCT-140924-3';
...
update construct set construct_name='Tg(gja9a.5:MA-GFP)' where construct_zdb_id='ZDB-TGCONSTRCT-150319-1';
update marker set mrkr_name='Tg(gja9a.5:MA-GFP)' where mrkr_zdb_id='ZDB-TGCONSTRCT-150319-1';
update marker set mrkr_abbrev='Tg(gja9a.5:MA-GFP)' where mrkr_zdb_id='ZDB-TGCONSTRCT-150319-1';
