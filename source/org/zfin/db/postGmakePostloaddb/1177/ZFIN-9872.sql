...
-- Update marker_relationship (antibody to gene relationships)
...
-- Add alias for the merged antibody name
INSERT INTO data_alias (dalias_zdb_id, dalias_data_zdb_id, dalias_alias, dalias_group_id)
VALUES (get_id_and_insert_active_data('DALIAS'), 'ZDB-ATB-120322-1', 'Ab2-ctsk', '1');
...
-- Add alias for the merged antibody name
INSERT INTO data_alias (dalias_zdb_id, dalias_data_zdb_id, dalias_alias, dalias_group_id)
VALUES (get_id_and_insert_active_data('DALIAS'), 'ZDB-ATB-090130-1', 'Ab4-ptk2a', '1');
...
-- Add alias for the merged antibody name
INSERT INTO data_alias (dalias_zdb_id, dalias_data_zdb_id, dalias_alias, dalias_group_id)
VALUES (get_id_and_insert_active_data('DALIAS'), 'ZDB-ATB-081124-4', 'Ab3-gcg', '1');
...
-- Add alias for the merged antibody name
INSERT INTO data_alias (dalias_zdb_id, dalias_data_zdb_id, dalias_alias, dalias_group_id)
VALUES (get_id_and_insert_active_data('DALIAS'), 'ZDB-ATB-181001-1', 'Ab3-opa1', '1');
...
-- Add alias for the merged antibody name
INSERT INTO data_alias (dalias_zdb_id, dalias_data_zdb_id, dalias_alias, dalias_group_id)
VALUES (get_id_and_insert_active_data('DALIAS'), 'ZDB-ATB-090304-2', 'Ab1-brdu/idu', '1');
...
-- Add alias for the merged antibody name
INSERT INTO data_alias (dalias_zdb_id, dalias_data_zdb_id, dalias_alias, dalias_group_id)
VALUES (get_id_and_insert_active_data('DALIAS'), 'ZDB-ATB-130808-2', 'Ab1-cdk1', '1');
...
-- Add alias for the merged antibody name
INSERT INTO data_alias (dalias_zdb_id, dalias_data_zdb_id, dalias_alias, dalias_group_id)
VALUES (get_id_and_insert_active_data('DALIAS'), 'ZDB-ATB-151005-6', 'Ab3-gnb1', '1');
...
-- Add alias for the merged antibody name
INSERT INTO data_alias (dalias_zdb_id, dalias_data_zdb_id, dalias_alias, dalias_group_id)
VALUES (get_id_and_insert_active_data('DALIAS'), 'ZDB-ATB-160518-1', 'Ab1-havcr', '1');
...
-- Add alias for the merged antibody name
INSERT INTO data_alias (dalias_zdb_id, dalias_data_zdb_id, dalias_alias, dalias_group_id)
VALUES (get_id_and_insert_active_data('DALIAS'), 'ZDB-ATB-160518-1', 'Ab2-havcr1', '1');
