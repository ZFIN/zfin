...
create table pub_correspondence_sent_recipient (pubcsr_pk_id serial8 not null constraint pubcsr_pk_id_not_null,
						...
						pubcsr_recipient_group_id int8 not null constraint pubcsr_recipient_group_id_not_null)
fragment by round robin in tbldbs1, tbldbs2, tbldbs3
extent size 4096 next size 4096;


create table pub_correspondence_sent_recipient_group (pubcsrg_group_id serial8 not null constraint pubcsrg_group_id_not_null)
fragment by round robin in tbldbs1, tbldbs2, tbldbs3
extent size 4096 next size 4096;
...
create table pub_correspondence_sent_text (pubcst_pk_id serial8 not null constraint pubcst_pk_id_not_null,
					   ...
					   pubcst_subject varchar(100) not null constraint pubcst_subject_not_null)
fragment by round robin in tbldbs1, tbldbs2, tbldbs3
extent size 4096 next size 4096;
...
create table pub_correspondence_sent (pubcs_pk_id serial8 not null constraint pubcs_pk_id_not_null,
					...
					pubcs_date_sent datetime year to day default datetime year to second not null constraint pubcs_date_sent_not_null,
					...
					pubcs_recipient_group_id int8 not null constraint pubcs_recipient_group_id_not_null)
fragment by round robin in tbldbs1, tbldbs2, tbldbs3
extent size 4096 next size 4096;
...
create table pub_correspondence_received (pubcr_pk_id serial8 not null constraint pubcr_pk_id_not_null,
					       ...
					       pubcr_subject varchar(100) not null constraint pubcr_subject_not_null)
fragment by round robin in tbldbs1, tbldbs2, tbldbs3
extent size 4096 next size 4096;
