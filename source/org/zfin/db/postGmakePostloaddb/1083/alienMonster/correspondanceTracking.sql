...
create table pub_correspondance_tracking (pct_pk_id serial8 not null constraint pubct_pk_id_not_null,
					  ...
					  pct_entered_by varchar(50) not null constraint pubct_entered_by_not_null)
