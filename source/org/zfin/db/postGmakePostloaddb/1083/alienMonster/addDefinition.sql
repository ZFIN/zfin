...
alter table pub_tracking_status
 add (pts_definition varchar(255) )
;
...
and pts_status_qualifier = 'Waiting for Nomenclature';

update pub_tracking_Status
  set pts_definition = 'This paper is currently waiting for ontology terms, review and/or support.'
 where pts_status = 'WAIT'
and pts_status_qualifier = 'Waiting for Ontology';
...
update pub_tracking_Status
 ...
 where pts_status = 'WAIT'
and pts_status_qualifier = 'Waiting for Curator Review';

update pub_tracking_Status
  set pts_definition = 'This paper is waiting for a bug fix or feature enhancement.'
 where pts_status = 'WAIT'
and pts_status_qualifier = 'Waiting for Software Fix';

update pub_tracking_Status
  set pts_definition = ''
 where pts_status = ''
and pts_status_qualifier = '';
