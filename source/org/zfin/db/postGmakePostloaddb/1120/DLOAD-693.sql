...
--changeset pm:DLOAD-693
--ZIRc genotyping links

insert into foreign_db (fdb_db_name, fdb_db_query,fdb_db_display_name,fdb_db_significance) values ('ZIRC Protocol', 'http://zebrafish.org/fish/pdf/pcr','',2);
...
insert into pre_foreign_db_contains (prefbct_fdbcont_organism_common_name, prefbct_fdbcont_fdbdt_id, prefbct_fdbcont_fdb_db_id)
  select distinct 'Zebrafish', 13, fdb_db_pk_id
    from foreign_db
   where fdb_db_name = 'ZIRC Protocol';
