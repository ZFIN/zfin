...
select distinct sfclid, feature_zdb_id, location1,location1,assembly1,chromosome1,'ZDB-TERM-170419-250' from burgess_location_post,feature where (chromosome1 not like 'Zv%' or chromosome1 not like 'KN%')  and allele1||'Et'=feature_abbrev;
