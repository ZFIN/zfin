...
-- zygocity:
-- ZDB-LAB-130226-1  Stemple Lab or ZDB-LAB-070815-1 cuppen Lab
-- ZDB-PUB-171002-4
...
create temp table sanger_input_known (
     ...
     mutationtype varchar(25),accession varchar(10)
) with no log;
...
create table pre_feature (
        ...
        preftr_type varchar(25),preftr_accession varchar(10)
);
...
unload to 'ftr' select * from pre_feature;
...
unload to fmrelpre select * from pre_feature_marker_relationship;
