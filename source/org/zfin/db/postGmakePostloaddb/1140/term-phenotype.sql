...
drop table UI_PHENOTYPE_ZFIN_ASSOCIATION;
drop table UI_PHENOTYPE_WAREHOUSE_ASSOCIATION;
Drop table UI_TERM_PHENOTYPE_DISPLAY;

create table UI_TERM_PHENOTYPE_DISPLAY
(
...
ALTER TABLE UI_TERM_PHENOTYPE_DISPLAY
...
create table UI_PHENOTYPE_ZFIN_ASSOCIATION
(
    pza_gene_zdb_id  text,
    pza_phenotype_id integer
);

ALTER TABLE UI_PHENOTYPE_ZFIN_ASSOCIATION
...
ALTER TABLE UI_PHENOTYPE_ZFIN_ASSOCIATION
    ADD CONSTRAINT constraint_fk2
        FOREIGN KEY (pza_phenotype_id)
            REFERENCES UI_TERM_PHENOTYPE_DISPLAY (tpd_id);

create table UI_PHENOTYPE_WAREHOUSE_ASSOCIATION
(
    pwa_phenotype_warehouse_id integer,
    pwa_phenotype_id           integer
);

/*ALTER TABLE UI_PHENOTYPE_WAREHOUSE_ASSOCIATION
    ADD CONSTRAINT constraint_fk1
