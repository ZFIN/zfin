...
--changeset pm:CUR-913

create temp table sfclg (zdb text,ftr text,st integer,endloc integer,assembly text,chr integer);

insert into sfclg values ('ZDB-ALT-040720-42','ZDB-ALT-040720-42',10260854,10260854,'GRCz11',6);
...
insert into record_attribution (recattrib_Data_zdb_id,recattrib_source_zdb_id) select zdb,'ZDB-PUB-130905-29' from sfclg;
