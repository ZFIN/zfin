...
-- so we pass the bare type name 'ZLSUB'. It does NOT insert into
...
-- Prerequisites for get_id('ZLSUB'): the type must exist in
...
VALUES ('ZLSUB', current_date - 1, 'zirc', 'line_submission',
...
CREATE SEQUENCE IF NOT EXISTS zlsub_seq START 1;
