...
insert into pre_gene (gene_zdb_id,dblink_id, ensdarg_id , gene_abbrev,gene_name,featureabbrev) select geneabbrev,ensdargid,ensdargid,geneabbrev,geneabbrev,allele from featurezmpdata;
