...
insert into sanger_location_new (allele1, assembly1,chromosome1,location1)
 select distinct  allele,assembly,chromosome,location from sanger_location , feature where  assembly like 'GRC%' and allele=feature_Abbrev and feature_zdb_id like 'ZDB-ALT-181119%' and chromosome not like 'KN%';
