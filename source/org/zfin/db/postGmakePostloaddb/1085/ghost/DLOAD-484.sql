...
insert into data_alias (dalias_zdb_id,dalias_data_zdb_id,dalias_alias,dalias_group_id) select distinct aliasid,cloneid,clonealias,1 from tmp_clone_alias;
