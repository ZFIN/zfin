...
--changeset pm:ZFIN-6234a



-- create foreign_db record to antibody registry
insert into foreign_db (fdb_db_name, fdb_db_query, fdb_db_significance)
values ('ABRegistry', 'http://antibodyregistry.org/', 88);
