...
class NCBICharacterizationProcess {
    ...
    private void dumpExistingDatabase() {
        ...
        String command = """
                pg_dump -h db -Fc zfindb -t marker -t expression_experiment2 -t foreign_db_contains -t foreign_db -t db_link -t marker_relationship -t record_attribution -t reference_protein -t zdb_active_data -t zdb_object_type -t dblink_seq -f ./input/slimdb.bak
                """;
    ...
    private void createTempDatabase() {
        ...
        String command = """
                ...
                pg_restore -h db -d ncbi ./input/slimdb.bak
                psql -h db -d ncbi -f ./input/functions.sql
                """;
        System.out.println(command);
    }
