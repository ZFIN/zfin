...
public class DanreModGpadParser extends GpadParser {
     ...
     * {@inheritDoc}
     *
     * <p>True: this file is a merged superset of many sources, so {@code GafLoadJob} must run the
     * removal diff once per owning organization instead of once for the whole file.</p>
     */
    @Override
