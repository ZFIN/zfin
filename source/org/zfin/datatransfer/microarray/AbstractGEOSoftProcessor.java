...
public abstract class AbstractGEOSoftProcessor implements SoftParser {
    ...
    public File downloadFile() {
        ...
        try {
            ...
            logger.error("Failed to connect for file, will try to use existing file: " + fileName, socketException);
            if (localFile.exists()) {
            ...
            throw new RuntimeException("Failed to download file properly, bailing out of load", e);
        }
    }
