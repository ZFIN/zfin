...
public class HibernateExpressionRepository implements ExpressionRepository {
    ...
    public List<BasicExpressionDTO> getBasicExpressionDTOObjects() {
        ...
        final String expressionQueryString = "select distinct xpatres_zdb_id," +
                                             ...
                                             "  where fish_is_wildtype = true " +
                                             "  and genox_is_std_or_generic_control = true " +
                                             "  and xpatres_expression_found = true " +
    ...
    public FigureLink getExpressionSingleFigure(Marker marker) {
        String sql = """
            select distinct xpatfig_fig_zdb_id , f.fig_label
                 from expression_pattern_figure
...
//            """;
     ...
     */
/*
    public void createExpressionResult(ExpressionResult2 result, Figure singleFigure) {
        ...
        Session session = HibernateUtil.currentSession();
        ExpressionResult2 unspecifiedResult = getUnspecifiedExpressResult(result);
