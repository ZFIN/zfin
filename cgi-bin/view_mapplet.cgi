...
#
 {   ### mod it
  ...
  my $types = 'SSLP';
  my $anon_type = "RAPD\',\'RFLP\',\'BAC_END\',\'PAC_END\',\'SSR\',\'STS\',\'SNP";
  my $gene_type = "GENE";
  my $est_type  = "EST";
  my $bac_type  = "BAC\',\'PAC";
  ...
  if( (defined $Q->param("view_map")) && ($g_error == 0) ) { # view_map is defined and no error reported
    ...
    $types = "SSLP\',\'RAPD\',\'RFLP\',\'SSR\',\'STS\',\'SNP\',\'GENE\',\'BAC\',\'PAC'\,\'BAC_END\',\'PAC_END'\,\'EST\',\'FISH\',\'MUTANT\',\'LOCUS";
  ...
  ###
    ...
    foreach $panel (@panels) {
      ...
      if($print_type == 0){ $types = "SSLP\',\'RAPD\',\'RFLP\',\'SSR\',\'STS\',\'GENE\',\'BAC\',\'PAC\',\'BAC_END\',\'PAC_END\',\'EST\',\'FISH\',\'MUTANT\',\'LOCUS"; $print_type += 31;}
    ...
    if ($panel) {
      ...
      if($Q->param($panel.'_fish') && $Q->param($panel.'_fish')==1){$types = "$types\',\'$fish_type"; $print_type += 8; }
      if($Q->param($panel.'_bac')  && $Q->param($panel.'_bac')==1)    {$types = "$types\',\'$bac_type"; $print_type += 16; }
      if($print_type == 0){ $types = "SSLP\',\'RAPD\',\'RFLP\',\'SSR\',\'STS\',\'GENE\',\'EST\',\'BAC\',\'PAC\',\'BAC_END\',\'PAC_END\',\'FISH\',\'MUTANT\',\'LOCUS"; $print_type += 31;}
