...
$sqlForInferenceGroupMemberTable = "update inference_group_member set infgrmem_inferred_from = "."\"".$intoFieldValue."\""." where infgrmem_inferred_from = "."\"".$goawayFieldValue."\";";
                                     
$sql = qq(insert into merge_markers_sql(mms_mrkr_1_zdb_id,mms_mrkr_2_zdb_id,mms_sql) values ('$mergeId','$intoId','$sqlForInferenceGroupMemberTable'););
