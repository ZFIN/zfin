...
--update obo_file
--  set obofile_text = filetoblob("/research/zcentral/www_homes/hoover/server_apps/data_transfer/LoadGO/gene_ontology.obo", 'server')
--  where obofile_name = 'gene_ontology.obo';

--update obo_file
--  set obofile_text = filetoblob("/research/zcentral/www_homes/hoover/server_apps/data_transfer/PATO/quality.obo", 'server')
--  where obofile_name = 'quality.obo';

--update obo_file
--  set obofile_text = filetoblob("/research/zcentral/www_homes/hoover/server_apps/data_transfer/Anatomy/zebrafish_anatomy.obo", 'server')
