# $Id: chaos.pm 15549 2009-02-21 00:48:48Z maj $
# $Date: 2009-02-20 16:48:48 -0800 (Fri, 20 Feb 2009) $
#
...
sub _initialize {
    ...
    $self->handler->ev(chaos_metadata=>[
                                        ...
                                        [export_module_cvs_id=>'$Id: chaos.pm 15549 2009-02-21 00:48:48Z maj $'],
                                       ]);
