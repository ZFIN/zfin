create trigger atomic_phenotype_update_trigger update 
    of apato_start_stg_zdb_id,apato_end_stg_zdb_id,apato_subterm_zdb_id,
    apato_superterm_zdb_id,apato_pub_zdb_id,apato_quality_zdb_id 
