...
-- returning lvarchar
-- external name
-- "/research/zfin/chromix/private/lib/zextend.o(lower)"
-- language c
-- end function;
...
-- returning lvarchar
-- external name
-- "/research/zfin/chromix/private/lib/zextend.so(upper)"
-- language c
-- end function;
...
returning lvarchar
external name
"/research/zfin/chromix/private/lib/zextend.so"
language c
end function;
...
returning html
external name
"/research/zfin/chromix/private/lib/zextend.so(html_breaks_html)"
language c
end function;
...
returning boolean
external name
"/research/zfin/chromix/private/lib/zextend.so(webhtml_like)"
language c
end function;
