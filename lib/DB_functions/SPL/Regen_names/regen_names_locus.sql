create procedure regen_names_locus(zdbId like zdb_active_data.zactvd_zdb_id)

  -- ---------------------------------------------------------------------
  -- regenerates the names in fast search tables for a given locus.
  --
  -- INPUT VARS:
  --   zdbId    ZDB ID of the locus to regenerate names for.
  --
  -- OUTPUT VARS:
  --   none
  --
  ...
  -- EFFECTS:
  --   Success:
  --     Entries for this locus ZDB ID in all_map_names and all_name_parts 
  --       tables have been replaced with current names for the locus.
