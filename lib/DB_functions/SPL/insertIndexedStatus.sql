...
if ((status = 'Ready For Curation' or status like 'Closed%') and exists (Select 'x' from pub_tracking_history, pub_tracking_status where pth_status_id = pts_pk_id and pts_status = 'Indexing') )
  then 
