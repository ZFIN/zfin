<VirtualHost *:80>
    ...
    #LogFormat "%a %V %u %t \"%r\" %>s %b \"%{Referer}i\" \"%{User-Agent}i\" %D \"zfin_login:%{zfin_login}C\"" timing_with_cookie
    ...
    <Location /jbrowse>
        ...
        ProxyPass http://jbrowse_zfin_prod.alliancegenome.org/jbrowse/
        ProxyPassReverse http://jbrowse_zfin_prod.alliancegenome.org/jbrowse/
    </Location>
</VirtualHost>
