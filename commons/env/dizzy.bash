...
export DB_UNLOADS_PATH="/opt/zfin/unloads/databases/dizzydb"
export DEFAULT_EMAIL="ryanm@zfin.org"
export DOMAIN_NAME="zfin.org"
export DOWNLOAD_DIRECTORY="/research/zunloads/download-files/dizzy"
...
export SOLR_UNLOADS_PATH="/opt/zfin/unloads/solr/dizzydb"
