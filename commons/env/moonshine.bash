...
export DB_UNLOADS_PATH="/opt/zfin/unloads/databases/moonshinedb"
export DEFAULT_EMAIL="ryanm@zfin.org"
export DOMAIN_NAME="zfin.org"
export DOWNLOAD_DIRECTORY="/research/zunloads/download-files/moonshine"
...
export SOLR_UNLOADS_PATH="/opt/zfin/unloads/solr/moonshinedb"
