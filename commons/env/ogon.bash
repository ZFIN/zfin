...
export DB_UNLOADS_PATH="/opt/zfin/unloads/databases/ogondb"
export DEFAULT_EMAIL="cmpich@zfin.org"
export DOMAIN_NAME="zfin.org"
export DOWNLOAD_DIRECTORY="/research/zunloads/download-files/ogon"
...
export SOLR_UNLOADS_PATH="/opt/zfin/unloads/solr/ogondb"
