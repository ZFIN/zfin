...
export DB_UNLOADS_PATH="/opt/zfin/unloads/databases/trunkdb"
export DEFAULT_EMAIL="informix@zfin.org"
export DOMAIN_NAME="zfin.org"
export DOWNLOAD_DIRECTORY="/research/zunloads/download-files/trunk"
...
export SOLR_UNLOADS_PATH="/opt/zfin/unloads/solr/trunkdb"
