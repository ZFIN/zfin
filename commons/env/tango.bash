...
export DB_UNLOADS_PATH="/opt/zfin/unloads/databases/tangodb"
export DEFAULT_EMAIL="rtaylor@zfin.org"
export DOMAIN_NAME="zfin.org"
export DOWNLOAD_DIRECTORY="/research/zunloads/download-files/tango"
...
export SOLR_UNLOADS_PATH="/opt/zfin/unloads/solr/tangodb"
