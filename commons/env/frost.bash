...
export DB_UNLOADS_PATH="/opt/zfin/unloads/databases/frostdb"
export DEFAULT_EMAIL="cmpich@zfin.org"
export DOMAIN_NAME="zfin.org"
export DOWNLOAD_DIRECTORY="/research/zunloads/download-files/frost"
...
export SOLR_UNLOADS_PATH="/opt/zfin/unloads/solr/frostdb"
