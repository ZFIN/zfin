...
export DB_UNLOADS_PATH="/opt/zfin/unloads/databases/dicerdb"
export DEFAULT_EMAIL="rtaylor@zfin.org"
export DOMAIN_NAME="zfin.org"
export DOWNLOAD_DIRECTORY="/research/zunloads/download-files/dicer"
...
export SOLR_UNLOADS_PATH="/opt/zfin/unloads/solr/dicerdb"
