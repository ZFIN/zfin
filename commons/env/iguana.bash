...
export DB_UNLOADS_PATH="/opt/zfin/unloads/databases/iguanadb"
export DEFAULT_EMAIL="rtaylor@zfin.org"
export DOMAIN_NAME="zfin.org"
export DOWNLOAD_DIRECTORY="/research/zunloads/download-files/iguana"
...
export SOLR_UNLOADS_PATH="/opt/zfin/unloads/solr/iguanadb"
