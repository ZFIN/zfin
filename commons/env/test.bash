...
export CATALINA_BASE="/opt/zfin/catalina_bases/test"
export CATALINA_HOME="/opt/apache/apache-tomcat"
export CATALINA_PID="/opt/zfin/catalina_bases/test/catalina_pid"
...
export DOMAIN_NAME="test.zfin.org"
export DOWNLOAD_DIRECTORY="/research/zunloads/download-files/testdb"
export GBROWSE_PATH_FROM_ROOT="action/gbrowse/"
export GC_LOGGING_OPTS="-verbose:gc -verbose:sizes -XX:+PrintGCDetails -XX:+PrintGCDateStamps -XX:+PrintTenuringDistribution -Xloggc:/opt/zfin/catalina_bases/test/logs/gc.log"
export GRADLE_USER_HOME="~/.gradle"
export GROOVY_CLASSPATH="/opt/zfin/www_homes/test/home/WEB-INF/lib*:/opt/zfin/source_roots/test/ZFIN_WWW/lib/Java/*:/opt/zfin/www_homes/test/home/WEB-INF/classes:/opt/misc/groovy/lib/*"
export HAS_PARTNER="false"
export IMAGE_LOAD="/imageLoadUp"
export INDEXER_UNLOAD_DIRECTORY="/research/zunloads/indexes/testdb"
...
export JENKINS_HOME="/opt/zfin/www_homes/test/server_apps/jenkins/jenkins-home"
export JENKINS_PORT="9427"
export JPDA_ADDRESS="9327"
export LOADUP_FULL_PATH="/research/zcentral/loadUp/pubs"
export MUTANT_NAME="test"
...
export PRIMARY_COLOR="#ffa000"
export ROOT_PATH="/opt/zfin/www_homes/test"
export SHARED_DOMAIN_NAME="false"
export SMTP_HOST="localhost"
export SOLR_CORE="site_index_test"
export SOLR_HOME="/var/solr/data/site_index_test"
export SOLR_MEMORY="8g"
export SOLR_PORT="8983"
export SOLR_UNLOADS_PATH="/research/zunloads/solr/zfindb"
export SOURCEROOT="/opt/zfin/source_roots/test/ZFIN_WWW"
export SQLHOSTS_FILE="sqlhosts"
export SQLHOSTS_HOST="testbed.zfin.org"
export SWISSPROT_EMAIL_ERR="informix@zfin.org rtaylor@zfin.org"
export SWISSPROT_EMAIL_REPORT="informix@zfin.org rtaylor@zfin.org"
export TARGETCGIBIN="cgi-bin"
export TARGETFTPROOT="/opt/zfin/ftp/test/test"
export TARGETROOT="/opt/zfin/www_homes/test"
