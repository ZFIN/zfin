...
<table cellpadding="0" cellspacing="2" border="0" width="80%" bgcolor="#003366">
	...
	<tr>
	<td align="center">
	<form action="/action/view-classpath-info" method="POST">
	...
	<td class="listContent">
        <bean:write name="classpathForm" property="classLoaderName" />
            ...
            <logic:iterate id="library" name="classpathForm" property="classLoaderParents" type="org.zfin.framework.presentation.ClassLibraryWrapper" >
            <tr>
	...
	sun.boot.class.path)</i></td>
        ...
        <logic:iterate id="library" name="classpathForm" property="bootLibraries" type="org.zfin.framework.presentation.ClassLibraryWrapper" >
        <tr>
        <td class="listContent" >
                <bean:write name="library" property="libaryFileName"/>
	...
	java.ext.dirs)</i></td>
        ...
        <logic:iterate id="library" name="classpathForm" property="extensionLibraries" type="org.zfin.framework.presentation.ClassLibraryWrapper" >
        <tr>
        <td class="listContent" >
                <bean:write name="library" property="libaryFileName"/>
                </td>
	...
	java.class.path)</i></td>
        ...
        <logic:iterate id="library" name="classpathForm" property="applicationLibraries" type="org.zfin.framework.presentation.ClassLibraryWrapper" >
        <tr>
        <td class="listContent" >
                <bean:write name="library" property="libaryFileName"/>
                <logic:equal value="false" name="library" property="libraryFileExists" >
	...
	<td class="sectionTitle">WEB-INF Classes</td>
        ...
        <logic:iterate id="library" name="classpathForm" property="classesLibraries" type="org.zfin.framework.presentation.ClassLibraryWrapper" >
        <tr>
        <td class="listContent" >
                <bean:write name="library" property="libaryFileName"/>
                </td>
