...
<%@attribute name="summary" type="org.zfin.figure.presentation.FigurePhenotypeSummary" rtexprvalue="true"
             required="true" %>
    ...
    <table class="primary-entity-attributes">
        ...
        <c:if test="${!empty summary.experiments}">
            <tr>
                ...
                <td><zfin2:toggledExperimentList experimentList="${summary.experiments}" maxNumber="5"/></td>runZfinEnsemblTscripts.sh
            </tr>
        </c:if>
