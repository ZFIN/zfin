...
<zfin-search:resultTemplate result="${result}">
    ...
    <jsp:attribute name="curatorContent">
        <div class="pub-actions pull-right">
            ...
            <a class="btn btn-mini btn-default btn-pub-actions" href="/cgi-bin/webdriver?MIval=aa-link_authors.apg&OID=${result.id}">Link</a>
            <a class="btn btn-mini btn-default btn-pub-actions" href="/cgi-bin/webdriver?MIval=aa-edit_pub.apg&OID=${result.id}">Edit</a>
        </div>
    </jsp:attribute>
    <jsp:body>
    </jsp:body>
