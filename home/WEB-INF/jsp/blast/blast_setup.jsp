    ...
    <form:form action="/action/blast/blast" modelAttribute="formBean" enctype="multipart/form-data">
        ...
        <div style="float: right">
            ...
            <div style="float: right; width:480px; padding: 3px; border:1px solid #ccc; background: #eee">
                <fieldset style="border: none; margin: 0 0 0 3px; padding: 0;">
                    ...
                    <input type="button"
                           onclick="window.location='/action/blast/blast-view?resultFile='+document.getElementById('ticketNumber').value;"
                           value="GO">
                    </span>
                </fieldset>
            </div>
        ...
        <table width="300px;" style="clear: left; padding-top: 2px" border="0">
            ...
            <tr>
                ...
                <td>
                    <form:select path="program" items="${programs}" itemLabel="label" itemValue="value"
                                 cssClass="update-blast-option"/>
            ...
            <tr>
                <td valign="top">
                    ...
                    <div style="margin-top: .3em;">
                        <form:radiobutton id="queryTypeFASTA" path="queryType" value="FASTA"/> <label
                            for="queryTypeFASTA">FASTA / free-text format:</label> <form:errors path="querySequence"
                                                                                                cssClass="error"/>
                    </div>
                    <form:textarea path="querySequence" rows="6" cols="60"
                                   onchange="document.getElementById('queryTypeFASTA').checked=true;"
                                   onclick="document.getElementById('queryTypeFASTA').checked=true;"
                                   onkeypress="document.getElementById('queryTypeFASTA').checked=true;"/>
                    <br>
                    <form:radiobutton id="queryTypeSEQUENCE_ID" path="queryType" value="SEQUENCE_ID"/> or Sequence ID:
                    <form:input path="sequenceID" size="20"
                                onchange="document.getElementById('queryTypeSEQUENCE_ID').checked=true;"
                                onclick="document.getElementById('queryTypeSEQUENCE_ID').checked=true;"
                                onkeypress="document.getElementById('queryTypeSEQUENCE_ID').checked=true;"/>
                    <span style="font-size: small;">(separate multiple with ",")</span> <form:errors path="sequenceID"
                                                                                                     cssClass="error"/>
                    <br>
                    <form:radiobutton id="queryTypeUPLOAD" path="queryType" value="UPLOAD"/> or Upload a free-text file:
                    <input type=file id="sequenceFile" name="sequenceFile" size=30
                           onchange="document.getElementById('queryTypeUPLOAD').checked=true;">
        ...
        <fieldset style="width: 500px;">
            <legend>Options</legend>
                ...
                <%--<?/MICOMMENT>--%>
            <form:checkbox path="shortAndNearlyExact" id="SHORT" cssClass="update-blast-option"/><label for="SHORT">&nbsp;
            Search for short, nearly exact matches</label>
            <p>
                Expect:
                    <form:input path="expectValue" size="8"/>
                &nbsp;
                Word Size:
                    <form:input path="wordLength" size="2"/>
                &nbsp;
            <p>
                Set subsequence:
                From &nbsp;
                ...
                <br>
            <div id="filterDNA" style="display: inline;">
                Filter:
            ...
            <div id="filterProteins" style="display: none;">
                Matrix:
                ...
                <form:checkbox path="seg"/> SEG - Filter low compositional complexity regions
                <BR>
