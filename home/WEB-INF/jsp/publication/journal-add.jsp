...
<div class="container-fluid">
    ...
    <form:form id="journal-form"
        ...
        <div class="form-group">
            <form:label path="publisher" class="col-md-2 control-label">Publisher</form:label>
            <div class="col-md-4">
        ...
        <div class="form-group">
            <form:label path="alias" class="col-md-2 control-label">Synonyms</form:label>
            <div class="col-md-4">
        ...
        <div class="form-group">
            <form:label path="printIssn" class="col-md-2 control-label">Print ISSN</form:label>
            <div class="col-md-4">
        ...
        <div class="form-group">
            <form:label path="eIssn" class="col-md-2 control-label">Online ISSN</form:label>
            <div class="col-md-4">
        ...
        <div class="form-group">
            <form:label path="nlmID" class="col-md-2 control-label">NLMID</form:label>
            <div class="col-md-4">
        ...
        <div class="form-group">
            <form:label path="reproduceImages" class="col-md-2 control-label">Can Reproduce Images?</form:label>
            <div class="col-md-4">
