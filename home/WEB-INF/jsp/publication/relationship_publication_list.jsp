        ...
        <c:choose>
            <c:when test="${formBean.orderBy == 'author'}">
                <input type=button name=resultOrder
                       onClick="document.location.replace('relationship-publication-list?orderBy=date&markerRelationship.zdbID=${formBean.markerRelationship.zdbID}')"
                       value="Order By Date">
            </c:when>
            <c:otherwise>
                <input type=button name=resultOrder
                       onClick="document.location.replace('relationship-publication-list?orderBy=author&markerRelationship.zdbID=${formBean.markerRelationship.zdbID}')"
