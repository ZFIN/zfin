...
<z:devtoolsPage title="Phenotype Curation History">
    <table class="primary-entity-attributes">
        <tr>
            <th><span class="name-label">Phenotype Curation Summary: Statements</span> (last 2 days)</th>
        </tr>
        <tr>
            <td><a href="/action/devtool/phenotype-curation-history">Show Experiment History</a></td>
        </tr>
    </table>
        ...
        <c:forEach var="phenotypeStatement" items="${phenotypeStatements}" varStatus="loop">
            <zfin:alternating-tr loopName="loop">
                ...
                <td>
                    ...
                    <a href="/action/curation/pheno/${phenotypeStatement.phenotypeExperiment.figure.publication.zdbID}">(Pheno</a>)
