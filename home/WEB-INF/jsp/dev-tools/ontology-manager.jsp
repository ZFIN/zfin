...
<z:devtoolsPage title="Ontology Manager">
    ...
    <table width="100%">
        <tr>
            <td colspan="3">
                ...
                fast lookup purposes. There are Jenkins jobs that are configured to reload the
                ...
                <c:forEach var="value" items="${formBean.ontologyManager.loadingData}" varStatus="loop">
                    <c:if test="${zfn:isOntologyLoaded(formBean.ontologyManager,value.value.ontology)}">
                        ...
                        ld">
                            ...
                            <td>
                                <zfin2:lookup ontologyName="${value.value.ontology.toString()}" id="${loop.count}"
                                              wildcard="false"  useIdAsTerm="true" termsWithDataOnly="false"/>
                            </td>
                        </tr>
                    </c:if>
                </c:forEach>
