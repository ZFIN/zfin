...
<z:devtoolsPage title="Thread Info">
    ...
    <table class="summary">
        ...
        <c:forEach var="thread" items="${allThreads}" varStatus="loop">
            <zfin:alternating-tr loopName="loop">
                ...
                <td><a href="single-thread-info/${thread.threadId}"> ${thread.threadName}</a>
                    <a href="single-thread-info/${thread.threadId}" class="popup-link data-popup-link"/>
