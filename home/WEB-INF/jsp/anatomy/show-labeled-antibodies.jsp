                ...
                <td>
                    <c:if test="${antibodyStats.numberOfFigures > 0}">
                        ...
                        <c:if test="${antibodyStats.numberOfFigures > 1}">
                            <a href='/action/antibody/antibody-figure-summary?superTermID=${formBean.aoTerm.zdbID}&antibodyID=${antibodyStats.antibody.zdbID}'>
                        ...
                        <zfin2:showCameraIcon hasImage="${antibodyStats.numberOfImages > 0}"/> from
...
<zfin2:anatomyTermDetailSectionCaption anatomyItem="${formBean.aoTerm}"
                                       ...
                                       structureSearchLink="/action/antibody/antibody-do-search?antibodyCriteria.includeSubstructures=false&antibodyCriteria.anatomyTermNames=${formBean.aoTerm.termName}&antibodyCriteria.anatomyTermIDs=${formBean.aoTerm.zdbID}&action=SEARCH"
                                       substructureSearchLink="/action/antibody/antibody-do-search?antibodyCriteria.includeSubstructures=true&antibodyCriteria.anatomyTermNames=${formBean.aoTerm.termName}&antibodyCriteria.anatomyTermIDs=${formBean.aoTerm.zdbID}&action=SEARCH"
