...
<form:form action="/action/antibody/create" method="post">
              ...
              <form:input path="<%= CreateAntibodyFormBean.NEW_AB_NAME%>" size="25" onkeypress="return noenter(event)" ></form:input>
              ...
              <form:input path="<%= CreateAntibodyFormBean.AB_PUBLICATION_ZDB_ID%>" size="25" onkeypress="return noenter(event)"></form:input>
