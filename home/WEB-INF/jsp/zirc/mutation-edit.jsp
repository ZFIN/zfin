...
<c:set var="sections" value="${[GENERAL, GENES, LESIONS, ASSAYS, PHENOS, LETHALITY, PUBS]}"/>
...
<z:dataPage sections="${sections}" title="Edit Mutation: ${entityLabel}">
    ...
    <jsp:body>
        ...
        <div class="mt-4">
            <a class="btn btn-outline-secondary" href="/action/zirc/line-submission/${submission.zdbID}/edit">
