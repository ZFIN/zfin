                                            ...
                                            <z:section title="Genotyping Assay ${galoop.count}" cssClass="ml-4">
                                                <table class="table table-borderless w-auto">
                                                    <tbody>
                                                        ...
                                                        <tr><th><span class="status-slot"><z:zirc-status-badge status="${gaFieldStatus['restrictionEnzymeVendor']}"/></span>Restriction Enzyme Vendor</th>
                                                            <td><c:choose><c:when test="${not empty ga.restrictionEnzymeVendor}"><c:out value="${ga.restrictionEnzymeVendor}"/></c:when><c:otherwise><span class="text-muted">&mdash;</span></c:otherwise></c:choose><z:zirc-field-history fieldName="restrictionEnzymeVendor" label="Restriction Enzyme Vendor" updates="${gaFieldUpdates['restrictionEnzymeVendor']}" scope="${gaScope}"/><z:zirc-field-comments recId="${gaRecId}" scope="field" fieldName="restrictionEnzymeVendor" label="Restriction Enzyme Vendor"/></td></tr>
                                                        ...
                                                        <tr><th><span class="status-slot"><z:zirc-status-badge status="${gaFieldStatus['dcapsMismatchPrimerChoice']}"/></span>Primer With Introduced Mismatch</th>
                                                            <td><c:choose><c:when test="${not empty ga.dcapsMismatchPrimerChoice}"><c:out value="${ga.dcapsMismatchPrimerChoice}"/></c:when><c:otherwise><span class="text-muted">&mdash;</span></c:otherwise></c:choose><z:zirc-field-history fieldName="dcapsMismatchPrimerChoice" label="Primer With Introduced Mismatch" updates="${gaFieldUpdates['dcapsMismatchPrimerChoice']}" scope="${gaScope}"/><z:zirc-field-comments recId="${gaRecId}" scope="field" fieldName="dcapsMismatchPrimerChoice" label="Primer With Introduced Mismatch"/></td></tr>
