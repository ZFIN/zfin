...
<div class="popup-body">
    ...
    However, we recommend that you conduct independent sequence analysis using your specific strain before ordering any reagent.
    </p>
    <p>
    Morpholino data has been curated since 2004, CRISPR and TALEN data since 2013.
    </p>
