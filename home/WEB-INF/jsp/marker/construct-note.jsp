...
<div class="popup-body">
    Transgenic constructs, or transgenes, are exogenous DNA sequences introduced into the genome

    This section contains three types of data for transgenic constructs that have been associated with this gene:
    <p>
    <ol>
