...
<div class="popup-body">
    <p>Transgenic constructs, or transgenes, are exogenous DNA sequences introduced into the genome.</p>

    <p>This section contains three types of data for transgenic constructs that have been associated with this gene:</p>

    <ol>
    <li>     Regulatory Regions are those sequences required for regulating the spatial and temporal expression pattern of a transgene.
