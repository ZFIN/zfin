...
<zfin2:uninformativeName name="${formBean.marker.abbreviation}" fromChimericClone="${formBean.hasChimericClone}"/>
...
<zfin2:mutantsInGene bean="${formBean.mutantOnMarkerBeans}" marker="${formBean.marker}"/>
...
<%-- gene ontology--%>
<zfin2:geneOntology data="${formBean.geneOntologyOnMarkerBeans}" marker="${formBean.marker}" webdriverRoot="<%=ZfinPropertiesEnum.WEBDRIVER_PATH_FROM_ROOT.toString()%>"/>
