...
<div class="popup-body">
    ...
    <p>
        The transcript records are added to ZFIN and linked to ZFIN gene records during a data exchange with Ensembl,
        where the transcript records are generated. Transcript annotations are derived from manual annotations by the
        HAVANA team at the Sanger Institute or through automated annotation by the Ensemble annotation pipeline. Some
        non-coding transcripts are added to ZFIN through manual curation of literature by ZFIN Staff. A detailed
        description of the transcript types can be accessed by clicking on the 'i' icon next to the Type column heading
        in the table.
    </p>
