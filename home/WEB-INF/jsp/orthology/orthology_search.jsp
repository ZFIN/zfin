...
<form:form method="POST" modelAttribute="formBean" action="do-search">
<table width="100%">
    <tr>
        <td class="titlebar">
                    ...
                    <td colspan=4>
                        ...
                        <table cellspacing="5">
                            <tr>
                                ...
                                <td>
                                    <form:radiobutton path="ordering" value="Zebrafish.symbol"/> Gene Symbol in
                                    Zebrafish
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                                <td>
                                    <form:radiobutton path="ordering" value="Zebrafish.chromosome"/> Chromosomal
                                    location in Zebrafish
                                </td>
                            </tr>
                        </table>
                <tr>
