        ...
        <div class="col-sm-6">
            <a href="/zf_info/zebraShareSubmission.xlsx" class="zebrashare-button">
                <span class="inner">
                    ...
                    <span class="info">
                        <h3>Download Submission Workbook</h3>
                        <p>Get started by filling out the details for your alleles</p>
                    </span>
                </span>
            </a>
        </div>
        <div class="col-sm-6">
            <a href="/action/zebrashare/new" class="zebrashare-button">
                <span class="inner">
                    <i class="fas fa-upload icon"></i>
                    <span class="info">
                        <h3>Submit Completed Workbook</h3>
                        <p>ZFIN curators will process your submission as part of their high priority literature curation workflow</p>
                    </span>
                </span>
