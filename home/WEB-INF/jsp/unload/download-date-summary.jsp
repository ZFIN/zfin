...
<z:page title="ZFIN Downloads Archive: ${dynamicTitle}">
    <table width="100%">
        <tr>
            ...
            <td align="right"><a HREF="https://wiki.zfin.org/display/general/WARRANTY+AND+LIABILITY+DISCLAIMER%2C+OWNERSHIP%2C+AND+LIMITS+ON+USE">Warranty Disclaimer and Copyright Notice</a>&nbsp;&nbsp;</td>
        </tr>
    </table>
    ...
    <table class="summary groupstripes">
        ...
        <tr>
            ...
            <td><a HREF="https://current.geneontology.org/annotations/zfin.gaf.gz">gene_association.zfin.gz</a>
            </td>
            <td>weekly</td>
            <td>
