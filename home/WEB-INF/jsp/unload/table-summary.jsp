            ...
            <tr>
                ...
                <span id="showNameDeleted-${entity.entityId}">
                    (<a onclick="jQuery('#showNameDeleted-${entity.entityId}').hide();
                        ...
                        jQuery('#nameDeleted-${entity.entityId}').load('/action/unload/fetch-entity-record?entityID=${entity.entityId}&tableName=${tableName}&date=${map.key}', function() { processPopupLinks(); }); return false;"
            ...
            <tr>
                ...
                <span id="showName-${entity.entityId}">
                    (<a onclick="jQuery('#showName-${entity.entityId}').hide();
                        ...
                        jQuery('#name-${entity.entityId}').load('/action/unload/fetch-entity-record?entityID=${entity.entityId}&tableName=${tableName}&date=${map.key}', function() { processPopupLinks(); }); return false;"
            ...
            <tr>
                ...
                <span id="showNameUpdate-${entity.entityId}">
                    (<a onclick="jQuery('#showNameUpdate-${entity.entityId}').hide();
                        ...
                        jQuery('#nameUpdate-${entity.entityId}').load('/action/unload/fetch-changed-entity-records?entityID=${entity.entityId}&tableName=${tableName}&date=${map.key}', function() { processPopupLinks(); }); return false;"
