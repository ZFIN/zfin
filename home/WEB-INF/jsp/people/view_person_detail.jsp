...
<table cellpadding=5 width=100%>
                ...
                te logic would be controlled in Java class -->
                        <authz:authorize ifAnyGranted="root,adminasst">
                            <table border="1" cellpadding="3" width="60%" bgcolor="#eeeeee">
                                ...
                                <tr>
                                    <td>Role</td>
                                    <td><c:out value="${profileForm.user.role}"/></td>
                                </tr>
                                <tr>
                                    <td>Last Login:</td>
                                    <td>Date: <fmt:formatDate value="${profileForm.user.loginDate}"
                                                              type="date"/>
                                        <br/> Time: <fmt:formatDate value="${profileForm.user.loginDate}" type="time"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Previous Login:</td>
                                    <td>Date: <fmt:formatDate
                                            value="${profileForm.user.previousLoginDate}"
                                            type="date"/>
                                        <br/> Time: <fmt:formatDate value="${profileForm.user.previousLoginDate}"
                                                                    type="time"/></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>Date: <fmt:formatDate
                                            ...
                                            type="date"/>
                                        <br/> Time: <fmt:formatDate value="${profileForm.user.accountCreationDate}"
                                                                    type="time"/>
                                    </td>
                                </tr>
                                <tr>
    ...
    <TR>
        <TD>
            ...
            <B> Publications not related to Zebrafish:</B></TD>
    </TR>
