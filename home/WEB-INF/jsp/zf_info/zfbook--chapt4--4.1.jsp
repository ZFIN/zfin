...
<z:page title="ZFIN: Zebrafish Book: Microscopic Observations">
...
<h2>REMOVING EMBRYOS FROM THEIR CHORIONS</h2>
(Source: M. Westerfield)<p>
  Some observations of zebrafish development can be made directly through the chorion.i.Chorion;, however for most procedures it is better to remove the chorion. When raised in Embryo Medium at 28.5&#176;C, zebrafish develop normally outside their chorions.  Chorions can be removed easily with sharp forceps (Dumont No. 5) by gently making a tear in the chorion and turning it upside down so that the embryo falls out.  To remove the chorions from young embryos (up to 15 h) care must be taken when opening the chorion because these embryos are easily damaged.<br>
<br>
  Pretreatment with a dilute solution of pronase (2 mg/ml in Embryo Medium, 1 min, 28.5&#176;C) makes the chorions brittle and easier to remove.  Older embryos require longer in the pronase.  Be sure to rinse the pronase treated embryos thoroughly at least 3 or 4 times to remove all the enzyme.  Embryos usually fall out of their chorions with gentle swishing during the rinse.<br>
<br>
