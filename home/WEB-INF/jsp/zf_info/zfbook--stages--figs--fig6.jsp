...
</p><p>Fig. 6.   Diagrammatic animal polar views of the planes of the first 5 cleavages.  The outer circle is the yolk, and the inner ellipse in <b>A</b> is the uncleaved blastodisc.  <b>B-F</b> show successive cleavages, with odd numbered cleavages cutting the short axis of the blastodisc and even numbered ones cutting the long axis.  From Kimmel et al. (1991).</p><p>
<img src="fig6.gif"><br>Figure 6 <br>
</p><hr>
<script>
