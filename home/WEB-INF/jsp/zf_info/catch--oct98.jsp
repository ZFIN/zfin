...
<zfin2:page title="ZFIN Zebrafish Genomics Initiative">
<div><p>
...
website.
</p><p>As the mapping strains SJD and C32 have residual polymorphism (less
...
</p><p>Discussion focused on two topics -- stock centers and avoiding redundancy
...
</p><p><b>Dr. Leonard Zon</b>, Children's Hospital Corporation, Boston, will
...
</p><p>Currently, two RH panels are available -- the Ekker panel and Goodfellow
...
</p><p>RH and genetic maps yield similar results, but the genetic map is more
...
</p><p><b>Dr. Mark Fishman</b>, Massachusetts General Hospital (MGH), plans
...
</p><p>Microsatellite markers present several advantages over other types of
...
</p><p>Data will be posted on the local MGH website (<a href="http://zebrafish.mgh.harvard.edu">http://zebrafish.mgh.harvard.edu
</a>),
ZFIN (<a href="/ZFIN/">http://zfin.org/ZFIN/
</a>),
...
strains.
</p><p>Subsequent discussion questioned the optimal number of markers, based
...
</p><p><b>Dr. William Talbot</b>, Skirball Institute, New York University Medical
...
and human.
</p><p>A framework map will be constructed by assigning 500 publicly available
...
</p><p>Discussion focused on DNA libraries. Dr. Marco Marra explained that
...
</p><p><b>Dr. Marnie Halpern</b>, Carnegie Institute of Washington, will produce
...
</p><p>Deficiency genome DNA samples will be typed using mapping primers derived
...
</p><p>Requested deficiency mutation strains will be thawed for <i>in vitro</i>
...
</p><p>Dr. Fishman stated that his team could help select microsatellite markers
...
</p><p>Discussion centered on the compatibility of mapping software, the compatibility
...
</p><p>The second issue discussed at the meeting involves integrating data
...
is also planned.
</p><p>Participants agreed that new data should be made publicly available
