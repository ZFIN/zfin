...
</p><h3><a name="1">Velvet disease</a></h3>
...
<p>
</p><h4>Symptoms of velvet disease:</h4>
<ul>
<li>rubbing behavior
	</li><li>lethargy
	</li><li>fins held close to the body
	</li><li>parasites near fins and gills
</li></ul><p>
Although velvet disease is extremely contagious, it can be cured with minimal damage to the fish using a 3-day treatment with Atabrine (Quinacrine hydrochloride).</p><p>
</p><h4>Treatment for velvet disease:</h4>
<dir>
<li>Day 1
		<ul>
<li>Turn off incoming water.	
		</li><li>Slowly drip 2 liters of sea salts into an infected 10-gallon tank.
		</li><li>Add 3.3 ml of the Atabrine stock solution.
	</li></ul><br>
</li><li>Day 2 
		<ul>
<li>Add 3.3 ml Atabrine stock.
	</li></ul><br>
</li><li>Day 3
		<dir>
<li>Add another 3.3 ml Atabrine stock for a total of 9.9 ml.
		</li><li>At the end of the 3-day period, clean the bottom of the tank thoroughly and slowly dilute out the salt and the Atabrine with fresh water.  
		</li><li>Continue cleaning the bottom of the tank daily for several days.
	</li></dir>
</li><li>Solutions:
<ul>
<li>Atabrine Stock:10 mg/ml dH2O. Store in light tight bottle.
	</li><li>Salt Stock: 20 tablespoons (280 g) Instant Ocean Sea Salts (Aquarium Systems, Inc.) dissolved in 2 liters distilled water
</li></ul><p>
</p><p>
</p><h3><b><a name="2">Mycobacteriosis</a></b></h3>
...
Symptoms of Mycobacteriosis:
	<ul>
<li>listlessness; the fish may isolate itself from other fish and refuse to eat
		</li><li>emaciation; hence, the name "skinny"
		</li><li>skin ulcers
		</li><li>spinal curvature
		</li><li>pigment change
		</li><li>grey-white nodules in internal organs
</li></ul></ul>
...
</p><h3><b><a name="3">Intestinal Capillariasis</a></b></h3>
...
different developmental stages can be found in the <i>Handbook of Fish
Diseases</i>, Dieter Untergasser, Editor (TFH publications, 1989, p. 104-105).
...
<b>References:</b></p><p>
Goven, B.A. and Amend D.F. (1982) Mebendazole/trichlorfon combinations: A new anti-helminthic for removing monogenetic trematodes from fish.  <i>J. Fish
Biol</i>. <b>20</b>:373-378.
</p><hr>
