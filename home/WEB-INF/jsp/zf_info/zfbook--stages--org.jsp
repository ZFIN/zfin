...
<zfin2:page title="ZFIN Zebrafish Developmental Organization">
...
Sons, Inc.
	...
	As an aid to communicating a broader perspective towards development, we group the stages into larger time-blocks called periods <a href="figs/table1.html">(Table 1)</a>, and summarize in the text the principal events during these periods.  Specialized terms are defined in the glossary, and <b>bold-face type</b> in the text highlights terms important for staging.  <a href="figs/table2.html">Table 2</a> collects brief descriptions of all the stages, and <a href="figs/fig1.html">Fig. 1</a> shows corresponding sketches.  One can use these two sources to locate approximately a stage of interest, and then find additional detail as necessary in the text and other figures.
</p><hr>
