...
<zfin2:page title="ZFIN: Zebrafish Book: Microscopic Observations">
...
<h1>CHAPTER 4 - MICROSCOPIC OBSERVATIONS</h1>
<h2>AGAR MOUNTING</h2>
(Source: J. Eisen)<p>
...
<p>
1.  Prepare a 1.2% solution of agar in embryo medium (or Ringers solution if the embryos are to be injected or prepared for some other invasive procedure; see <a href="/zf_info/zfbook/chapt10.html">RECIPES</a>, Chapter 10) by heating in a boiling water bath or in a microwave oven.  This solution remains liquid at 37-40&#176;C, but quickly hardens when cooled.
</p><p>
...
</p><h3>Removing embryos from agar</h3>
<p>

1.  To remove an embryo from the agar, place several drops of medium on top of the agar.
</p><p>
2.  Using a pointed scalpel or a minutien pin attached to a needle holder or applicator stick, create a "V" shaped cut in the agar with the point of the "V" aiming towards the embryo's head.</p><p>

3.  Hold the tips of a pair of sharp forceps closed and plunge them into the agar between the point of the "V" cut and the head of the embryo.</p><p>

4.  Gently open the points of the forceps creating a crack in the agar which will run along the length of the embryo.</p><p>
