...
</p><p>Fig. 8.   Face views of embryos during the blastula period.  <b>A</b>: 256-cell stage (2.5 h).  <b>B</b>: high stage (3.3 h). <b> C</b>. transition between the high and oblong stages (3.5 h).  <b>D</b>. transition between the oblong and sphere stages (3.8 h).  <b>E</b>: dome stage (4.3 h).  <b>F</b>. 30%-epiboly stage (4.7 h).  Scale bar: 250 &#181;m.</p><p>
<img src="fig8.gif"><br>Figure 8 <br>
</p><hr>
<script>
