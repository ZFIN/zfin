...
<h2>Simple Schedule For Breeding Zebrafish</h2>
                               (Source: M. Westerfield)<br>
<br>
<b><i>Breeding days</i></b>:<pre>
        <i>Dawn</i>: feed dry/moist food and brine shrimp
        <i>Hour 1</i>: siphon tank for embryos and replace 1/3 of the water
        <i>Evening</i>:feed flake food lightly
</pre>
<b><i>Non-breeding days</i></b>:<br>
<br>
    Feed flake food lightly, siphon tank to remove debris and replace 1/3 of the
water.
<hr>
