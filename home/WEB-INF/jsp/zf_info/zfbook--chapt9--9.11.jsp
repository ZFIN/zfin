...
<h2>A Simplified Ribonuclease Protection Assay for Embryos</h2>
 (Source: G.M. Kelly and R.T. Moon)<br>
<br>
      This is a ribonuclease protection assay based on the methods of Thompson
and Gillespie (<i>Anal. Biochem.</i> <b>163</b>:281-291, 1987) and
...
that an overnight exposure is sufficient to detect a <i>wnt1</i> signal from
...
abundance of a specific transcript.<br>
<br>
...
expel and repeat three times, then vortex and store at -20&#176;C.<br>
<br>
...
1x10<em sup="">5</em> cpm of <em sup="">32</em>P-UTP-labeled antisense probe
...
available from Ambion (Austin, TX) for making the probes.<br>
<br>
...
<i>torula</i> tRNA to ensure that the RNAse will digest any unprotected
single-stranded RNA molecules.<br>
<br>
...
at 55&#176;C and then, if necessary, alter the temperature in 5&#176;C intervals.<br>
<br>
...
<i>torula</i> RNA to each sample before centrifuging.  Air dry the pellets,
