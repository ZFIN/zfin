...
<z:dataTable collapse="true"
             hasData="${proteinExpressionDataList != null && fn:length(proteinExpressionDataList) > 0 }">
    <thead>
        <tr>
            <th>Antibody</th>
            <th>Antigen Genes</th>
    ...
    <tbody>
        <c:forEach var="xp" items="${proteinExpressionDataList}" varStatus="loop">
            <zfin:alternating-tr loopName="loop"
                                 groupBeanCollection="${proteinExpressionDataList}"
