...
const MarkerAddNucleotideSequences = ({markerId, group = 'gene edit addable nucleotide sequence', groupDB = 'gene edit addable nucleotide sequence'}) => {
    const links = useFetch(`/action/marker/${markerId}/geneNuclSequences?group=${group}`);
    const databases = useFetch(`/action/marker/link/nuclDatabases?group=${groupDB}`);
    ...
    const {
        ...
        addUrl: `/action/marker/${markerId}/nucleotide/seqLinks`,
    ...
    return (
        <>
            ...
            <AddEditDeleteModal {...modalProps} header=' Nucleotide Sequence'>
                {values && <>
                    {!isEdit &&
                    <FormGroup
...
MarkerAddNucleotideSequences.propTypes = {
    markerId: PropTypes.string,
    group: PropTypes.string,
    groupDB: PropTypes.string,
};

export default MarkerAddNucleotideSequences;
