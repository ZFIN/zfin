...
public class DatabaseServiceTest {
    ...
    public void testTripleJoinedJdbcStatement() {
        ...
        assertEquals("SELECT fish_1.* FROM fish as fish_1, fish_experiment as fish_experiment_1, " +
                "expression_experiment2 as expression_experiment2_1, expression_result2 as expression_result2_1 " +
                ...
                "AND expression_experiment2_1.xpatex_zdb_id = expression_result2_1.xpatres_xpatex_zdb_id", statement.getQuery());
