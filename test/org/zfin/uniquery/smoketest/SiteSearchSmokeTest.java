...
/**
 */
public class SiteSearchSmokeTest extends WebTestCase {

    protected static final String mutant = System.getenv("MUTANT_NAME");
    protected static final String domain = System.getenv("DOMAIN_NAME");
    ...
    public void testCadherin() {
        try {
            ...
            HtmlPage page = webClient.getPage("http://" + domain + "/action/quicksearch?query=" + query);
