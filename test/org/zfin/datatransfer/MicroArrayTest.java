...
public class MicroArrayTest {
    ...
    public void setUp() {
        ...
        initTestData();
        root = personRepository.getUser("ZDB-PERS-030520-1");
    }
...
//            criteria.add(Restrictions.eq("marker",geneDBLink.getMarker())) ;
    ...
    private void initTestData() {
        ...
        Publication refPub = publicationRepository.getPublication("ZDB-PUB-070122-15");
        assertTrue(refPub != null);
    }
    ...
    private void insertGeneMarker() {
        ...
        MarkerDBLink geneDBLink = new MarkerDBLink();
    ...
    private void insertReferencedMarkers() {
        ...
        // set to cDNA
        MarkerDBLink cDNADBLink = new MarkerDBLink();
        ...
        MarkerDBLink estDBLink = new MarkerDBLink();
