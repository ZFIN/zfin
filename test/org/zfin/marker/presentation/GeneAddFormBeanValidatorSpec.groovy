...
class GeneAddFormBeanValidatorSpec extends AbstractZfinIntegrationSpec {
    ...
    def "validator should reject #type form with #description"(String type, String description, String field, String value, String code) {
        ...
        "GENE"  | "name not provided"         | "name"          | ""                      || "gene.name.empty"
        "GENE"  | "name already used"         | "name"          | "paired box 2a"         || "gene.name.inuse"
        "EGF"   | "name already used"         | "name"          | "DsRed"                 || "gene.name.inuse"
        "GENE"  | "abbreviation not provided" | "abbreviation"  | ""                      || "gene.abbreviation.empty"
        "GENEP" | "abbreviation not provided" | "abbreviation"  | ""                      || "gene.abbreviation.empty"
        "GENEP" | "abbreviation already used" | "abbreviation"  | "hoxa10ap"              || "gene.abbreviation.inuse"
        "Gene"  | "pub not provided"          | "publicationId" | ""                      || "pub.empty"
        "EGF"   | "pub not valid"             | "publicationId" | "ZDB-PUB-111111-111111" || "pub.notfound"
    }
